...
public class ImageViewPagerAdapterNewsDetailsTrainee extends PagerAdapter {
    ...
    public ImageViewPagerAdapterNewsDetailsTrainee(Context context, List<ImageList> images ) {
